...
do
  ...
  do
    ...
    mkdir -p save_policy/humanoid_${uncertainty}_rank_${rank}
    ...
    do
      ...
      # 创建日志文件名
      log_file="logs/uncertainty_${uncertainty}/humanoid_seed_${seed}_rank_${rank}_RL.log"
      ...
      nohup bash -c "
        ...
        # 运行实验
        python -u ml/RL.py \
          --config configs/samples/ALR/humanoid_RL_${rank}.yml \
          --output ./save_policy/humanoid_${uncertainty}_rank_${rank}/seed_${seed}/model \
