  ...
  do
    ...
    do
      ...
      nohup bash -c "
        ...
        # stage 1
        python -u ml/RL.py \
          --config configs/samples/ALR/walker2d_ALR_interval_500.yml \
        ...
        python -u ml/svd_approximation.py \
          --policy_model_path ./save_policy/walker_interval_${interval}_uncertainty_${uncertainty}_beta_${beta}/seed_${seed}/stage1/Walker2dRandom-v0_epoch_495.pt \
        ...
        do
          ...
          python -u ml/svd_approximation.py \
            --policy_model_path ./save_policy/walker_interval_${interval}_uncertainty_${uncertainty}_beta_${beta}/seed_${seed}/stage\${i}/Walker2dRandom-v0_epoch_495.pt \
