...
class SAC:
    ...
    def __init__(self, env_fn, replay_buffer, k=1, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, 
        ...
        num_epochs=10000
        cosine_scheduler_pi = CosineAnnealingLR(self.pi_optimizer, T_max=num_epochs-warmup_steps)
        cosine_scheduler_q = CosineAnnealingLR(self.q_optimizer, T_max=num_epochs-warmup_steps)
        self.device = device
    ...
    def update(self,data,epoch=10000):
        # called by adv IRL
        ...
        if epoch < self.warmup_steps:
            ...
            cosine_scheduler_pi.step()
            cosine_scheduler_q.step()
