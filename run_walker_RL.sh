...
do
  ...
  mkdir -p save_policy/walker_${uncertainty}
  ...
  do
    ...
    # 创建日志文件名
    log_file="logs/uncertainty_${uncertainty}/walker_seed_${seed}_RL.log"
    ...
    nohup bash -c "
      ...
      # stage 1
      python -u ml/RL.py \
        --config configs/samples/ALR/walker2d_RL.yml \
        --output ./save_policy/walker_${uncertainty}/seed_${seed}/stage1 \
